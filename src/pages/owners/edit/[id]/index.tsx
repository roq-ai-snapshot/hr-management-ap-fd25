        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              ...
              isInvalid: !!formik.errors?.investment_amount,
            }}
            name="investment_amount"
            error={formik.errors?.investment_amount}
            value={formik.values?.investment_amount}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('investment_amount', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'shares_owned',
              isInvalid: !!formik.errors?.shares_owned,
            }}
            name="shares_owned"
            error={formik.errors?.shares_owned}
            value={formik.values?.shares_owned}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('shares_owned', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
