...
export function OwnerListPage(props: OwnerListPageProps) {
  ...
  const columns: ColumnType[] = [
    { id: 'ownership_percentage', header: 'ownership_percentage', accessorKey: 'ownership_percentage' },
    { id: 'investment_amount', header: 'investment_amount', accessorKey: 'investment_amount' },
    { id: 'shares_owned', header: 'shares_owned', accessorKey: 'shares_owned' },
